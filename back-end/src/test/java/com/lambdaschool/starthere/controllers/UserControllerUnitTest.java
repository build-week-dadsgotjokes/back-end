...
public class UserControllerUnitTest
{
    ...
    public void setUp() throws Exception
    {
        ...
        User u1 = new User("admin", "ILuvM4th!", admins, returnEmptyJokeLikes());
        ...
        User u2 = new User("cinnamon", "1234567", datas, returnEmptyJokeLikes());
        ...
        User u3 = new User("testingbarn", "ILuvM4th!", users, returnEmptyJokeLikes());
        ...
        User u4 = new User("testingcat", "password", users, returnEmptyJokeLikes());
        u4.setUserid(104);
        userList.add(u4);

        users = new ArrayList<>();
        users.add(new UserRoles(new User(), r2));
        User u5 = new User("testingdog", "password", users, returnEmptyJokeLikes());
        u5.setUserid(105);
        userList.add(u5);
